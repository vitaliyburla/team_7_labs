...
#include "../../Lab6Server/TestServer.h"
...
QT_MOC_LITERAL(13, 119, 9) // "userError"
    ...
    "TestServer\0logMessage\0\0msg\0stopServer\0"
...
void TestServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TestServer::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestServer::logMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TestServer::logMessage(const QString & _t1)
{
